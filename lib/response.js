...
var Response = {
    ...
    partial: function(view, data){
        return this.engines[this.app.settings.views.engine].render.call(this, this.app.cache['/views/' + view].body, data);
    },
    ...
    json: function(/* body, statusCode */){
        ...
        if (typeof body == 'object') {
            body = this.app.settings.troubleshooting ? JSON.stringify(body, null, 4) : JSON.stringify(body);
        }
