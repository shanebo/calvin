...
//		}
	...
	serve: function(asset){
		...
		if (asset.headers['Content-Type'] == 'text/html') {
			...
			if (!this.cache[this.request.url] && this.app.environment !== 'development' && this.app.memcachedRoutes && this.app.memcachedRoutes.test(this.request.pathname) && this.request.method === 'GET') {
				this.cache[this.request.url] = asset;
			}
		}
