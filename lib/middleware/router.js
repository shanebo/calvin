...
Router.prototype = {
	...
	get: function(route, handlers){
		return this.addRoute('get', route, handlers);
	},

	post: function(route, handlers){
		return this.addRoute('post', route, handlers);
	},
	...
	addRoute: function(method, route, handlers){
