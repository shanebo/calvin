...
const Sessions = function(app){
    this.key = keygrip([app.settings.sessions.secret || 'PutAS3CretHereANDmAK3itSUP3rG00d']);
    this.cookie = app.settings.sessions.cookie || 'calvin-session';
    this.csrf = app.settings.sessions.csrf || false;
}
